#include "kps_arnutrition_ARNutritionJNI.h"
...
extern "C" {
    ...
    Java_kps_arnutrition_ARNutritionJNI_findFeatures(JNIEnv*, jobject, jlong addrGray, jlong addrRgba,
                                                jint detectorChoice);
    JNIEXPORT void JNICALL
    Java_kps_arnutrition_ARNutritionJNI_threshCallback(JNIEnv*, jobject, jlong addrGray, jlong addrRgba);
     ...
     */
    JNIEXPORT void JNICALL
    Java_kps_arnutrition_ARNutritionJNI_morphOperations(JNIEnv*, jobject, jlong matAddrHsvThreshed)
    {
        // variable declaration
     ...
     */
    JNIEXPORT void JNICALL
    Java_kps_arnutrition_ARNutritionJNI_hsvMode(JNIEnv *env, jobject, jlong addrGray, jlong addrRgba,
                                        jintArray hsvFilterValues)
    {
        // variable declaration
        Mat& mGr  = *(Mat*)addrGray;
