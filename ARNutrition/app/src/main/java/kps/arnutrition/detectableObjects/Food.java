package kps.arnutrition.detectableObjects;
...
/**
 * class for located foods, consists of a FoodType, the contour and relevant positions such
 * as the mass center or the label location (defined as the outermost point on the right)
 *
 */
public class Food {
    // attribute section
    FoodType type;                 // specifies, to which food type this food belongs
     ...
     *
     * @param type          defines the type of the detected food
     * @param contour       describes the contour of the detected food within the frame
     */
    public Food(FoodType type, MatOfPoint contour) {
        ...
        // get and save the mass center of the detected object and put into food type
