...
/**
 * class specifies a category of food, e.g. apple, banana, orange, and also
 * the data belonging to this category - the class contains the name of the food type and
...
public class FoodType {
     ...
     * @param shape             shape of food type (contour of detected area)
     * @param markerColor       specifies the representative color of the food type
     */
    public FoodType(String name, int[] colorFilter, Mat hsvHistogramH, Mat hsvHistogramS,
